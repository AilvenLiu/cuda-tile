...
cuda_tile.module @itof_f8e8m0fnu {
  cuda_tile.entry @func() {
    %0 = cuda_tile.constant <i8: [1, 2]> : !cuda_tile.tile<2xi8>
    // expected-error @below{{op integer to f8E8M0FNU conversion is not supported, please first convert to another float type}}
    cuda_tile.itof %0 signed : !cuda_tile.tile<2xi8> -> !cuda_tile.tile<2xf8E8M0FNU>
  }
}
