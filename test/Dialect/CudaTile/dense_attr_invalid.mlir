...
cuda_tile.module @kernels {
  entry @kernel() {
    // expected-error-re@below {{expect element type to be one of i1 or i8 or i16 or i32 or i64 or f16 or bf16 or f32 or f64 or tf32 or f8E4M3FN or f8E5M2 or f8E8M0FNU or f4E2M1FN{{( or f8E5M3FNU)?}} values, but got '<<NULL TYPE>>'}}
...
cuda_tile.module @kernels {
  entry @kernel() {
    // expected-error-re@below {{expect element type to be one of i1 or i8 or i16 or i32 or i64 or f16 or bf16 or f32 or f64 or tf32 or f8E4M3FN or f8E5M2 or f8E8M0FNU or f4E2M1FN{{( or f8E5M3FNU)?}} values, but got 'tensor<i32>'}}
