// Test that invalid/unsupported hints produce warnings with -Wunsupported-hints
// RUN: cuda-tile-opt %s -Wunsupported-hints -verify-diagnostics -split-input-file
